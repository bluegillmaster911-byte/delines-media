(function () {
  ...
  function wireMailtoForms() {
    ...
    for (var i = 0; i < forms.length; i++) {
      ...
      if (txt.indexOf("look up") !== -1) continue;
      if (txt.indexOf("continue to checkout") !== -1) continue;
      if (txt.indexOf("add another") !== -1) continue;
      ...
      form.addEventListener(
        ...
        function (ev) {
          ...
          if (t.indexOf("look up") !== -1) return;
          if (t.indexOf("continue to checkout") !== -1) return;
          ev.preventDefault();
          ev.stopPropagation();
          if (ev.stopImmediatePropagation) ev.stopImmediatePropagation();
  ...
  setTimeout(reviveDeadPages, 1100);
})();
